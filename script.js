...
const translations = {
  ar: {
    dir: "rtl",
    title: "احمد وروان",
    kicker: "الحمد لله الذي يختار للقلوب ما يليق بها ويجبر بعطائه حين تظن ان الجبر بعيد لمن يكن لقائنا صدفه بل دعاء مستجاب<br>ولأن الفرح يزداد بوجود الاحبه ندعوكم لتشاركونا فرحتنا ولتصبح لحظتنا بكم أجمل",
  ...
  en: {
    dir: "ltr",
    title: "Ahmed & Rawan",
    kicker: "All praise is due to Allah who chooses for hearts what suits them and mends with His giving when you think healing is far away. Our meeting was not a coincidence but an answered prayer.<br>Because joy grows with the presence of loved ones, we invite you to share our happiness and make our moment more beautiful with you",
